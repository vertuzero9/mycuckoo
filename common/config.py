    ...
    configuration = {
        ...
        "ml": {
            "ml": {
                "data_directory": Path(
                        "sample_data/dict",
                        exists=False, writable=True, readable=True
                ),
                "clustering_parameters": String(),
                "save_clustering_results": Boolean(False),
                "clustering_results_directory": Path(
                        "sample_data/clust",
                        exists=False, writable=True, readable=True
                ),
                "abnormal_behaviour": Boolean(False),
                "anomalies_detection": Boolean(False),
                "save_csv": Path(
                        "sample_data/",
                        exists=False, writable=True, readable=True
                ),
